                             ...
                             <?php 
                                ...
                                foreach ($categories as $cat) {
                                    ?>
                                     ...
                                     <button class="accordion"><img src="http://swamivivekanandeduweltrust.com/programmer/masao/wp-content/uploads/2020/10/network_wire.png"><a href="<?php echo site_url(); ?>/video-category/<?=$cat->term_id?>/" for="<?=$cat->term_id?>"><?=$cat->name?></a></button>                                        
