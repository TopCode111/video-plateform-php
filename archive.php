<?php if ( !is_user_logged_in() ) { header("location:". site_url() ."/wp-login");}?>
     ...
     $catSlug = $cat_obj->slug;   
     $catName = $cat_obj->name;           
     $cat = get_term_by('slug',$catSlug,'video_categories');
     if ($cat){
     ?>
     <style type="text/css">
     	.banner.text-center.d-flex.align-items-center{
     		background-image:url("http://videolist.uh-oh.jp/wp-content/uploads/2020/10/What-is-Category.png") !important;
     	}
     </style>
                    ...
                    <div class="video-block-mian">
                        <div class="new-video-block">
                            <div class="title-video-block">
                                <h2 class="title-category"><a href="<?php echo site_url(); ?>">ホーム</a><span>></span><a><?php echo $catName; ?></a></h2>
                            </div>
...
<?php }
    ...
    $cat = get_term_by('slug',$catSlug,'qa_categories');?>
    <style type="text/css">
     	.banner.text-center.d-flex.align-items-center{
     		background-image:url("http://videolist.uh-oh.jp/wp-content/uploads/2020/10/qa.jpg") !important;
     	}
     </style>
    <div class="slideshow-container">
    ...
    <br>
     <div class="contact-page">
        <div class="container">
            <div class="main-page">
              <div class="sp_category" id="sp_categoryQ">カテゴリー</div>
                <div class="main-page-left">
...
$(document).ready(function(){
    ...
    var category_tapQ = true;
    $("#sp_categoryQ").click(function(e){
      if(category_tapQ == true){
          $(".main-page-left").css('display','block');
          category_tapQ = false;
      }else{
        category_tapQ = true;
